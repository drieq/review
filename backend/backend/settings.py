...
DEFAULT_FROM_EMAIL = 'test@drieq.com'
...
SESSION_COOKIE_SECURE = False # Set to False during local development with HTTP
CSRF_COOKIE_SECURE = False # Set to False during local development with HTTP
